...
- **Verified baseline:** 682 repository tests passing on 2026-09-02, plus 19 UI and 4 Sites tests, a production UI build, interactive keyboard/browser checks, and one accepted isolated Windows wheel installation. The full worker service still has not passed Ubuntu host acceptance; its test module is network-free acceptance logic, not a posture or live-host claim.
