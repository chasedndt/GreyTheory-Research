...
- programme registry and single-source scope compilation;
...
- programme compilation has only been exercised against in-house fixtures;
- authority is currently compiled from one supplied source rather than a `ProgrammeSourceBundle`;
