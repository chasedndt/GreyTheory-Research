...
- workbench claim-role binding and finding-lifecycle promotion remain later application use cases; authoring and passing Gates B-F alone cannot change lifecycle state;
